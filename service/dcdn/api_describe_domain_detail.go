...
func (s *CertBindForDescribeDomainDetailOutput) SetCertName(v string) *CertBindForDescribeDomainDetailOutput {
	s.CertName = &v
	return s
}
...
func (s *CertBindForDescribeDomainDetailOutput) SetExpire(v string) *CertBindForDescribeDomainDetailOutput {
	s.Expire = &v
	return s
}
...
func (s *ForceRedirectForDescribeDomainDetailOutput) SetRedirectCode(v int32) *ForceRedirectForDescribeDomainDetailOutput {
	s.RedirectCode = &v
	return s
}
...
func (s *HttpsForDescribeDomainDetailOutput) SetEnableHttps(v bool) *HttpsForDescribeDomainDetailOutput {
	s.EnableHttps = &v
	return s
}
...
func (s *HttpsForDescribeDomainDetailOutput) SetOCSPStapling(v bool) *HttpsForDescribeDomainDetailOutput {
	s.OCSPStapling = &v
	return s
}
