...
// DCDN provides the API operation methods for making requests to
// DCDN. See this package's package overview docs
// for details on the service.
//
// DCDN methods are safe to use concurrently. It is not safe to
...
// newRequest creates a new request for a DCDN operation and runs any
