...
// ACEP provides the API operation methods for making requests to
// ACEP. See this package's package overview docs
// for details on the service.
//
// ACEP methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *ACEP {
	svc := &ACEP{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ACEP operation and runs any
// custom request initialization.
func (c *ACEP) newRequest(op *request.Operation, params, data interface{}) *request.Request {
