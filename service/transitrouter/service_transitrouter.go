...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *TRANSITROUTER {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *TRANSITROUTER {
	svc := &TRANSITROUTER{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
