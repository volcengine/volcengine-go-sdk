...
const opGetArkclawOmniInstanceWebuiCommon = "GetArkclawOmniInstanceWebui"

// GetArkclawOmniInstanceWebuiCommonRequest generates a "volcengine/request.Request" representing the
// client's request for the GetArkclawOmniInstanceWebuiCommon operation. The "output" return
// value will be populated with the GetArkclawOmniInstanceWebuiCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned GetArkclawOmniInstanceWebuiCommon Request to send the API call to the service.
// the "output" return value is not valid until after GetArkclawOmniInstanceWebuiCommon Send returns without error.
//
// See GetArkclawOmniInstanceWebuiCommon for more information on using the GetArkclawOmniInstanceWebuiCommon
...
func (c *ARKCLAW) GetArkclawOmniInstanceWebuiCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
	op := &request.Operation{
		Name:       opGetArkclawOmniInstanceWebuiCommon,
		HTTPMethod: "POST",
		HTTPPath:   "/",
	}
...
// API operation GetArkclawOmniInstanceWebuiCommon for usage and error information.
func (c *ARKCLAW) GetArkclawOmniInstanceWebuiCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
	req, out := c.GetArkclawOmniInstanceWebuiCommonRequest(input)
	return out, req.Send()
}

// GetArkclawOmniInstanceWebuiCommonWithContext is the same as GetArkclawOmniInstanceWebuiCommon with the addition of
...
const opGetArkclawOmniInstanceWebui = "GetArkclawOmniInstanceWebui"

// GetArkclawOmniInstanceWebuiRequest generates a "volcengine/request.Request" representing the
// client's request for the GetArkclawOmniInstanceWebui operation. The "output" return
// value will be populated with the GetArkclawOmniInstanceWebuiCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned GetArkclawOmniInstanceWebuiCommon Request to send the API call to the service.
// the "output" return value is not valid until after GetArkclawOmniInstanceWebuiCommon Send returns without error.
//
// See GetArkclawOmniInstanceWebui for more information on using the GetArkclawOmniInstanceWebui
// API call, and error handling.
//
...
func (c *ARKCLAW) GetArkclawOmniInstanceWebuiRequest(input *GetArkclawOmniInstanceWebuiInput) (req *request.Request, output *GetArkclawOmniInstanceWebuiOutput) {
	op := &request.Operation{
		Name:       opGetArkclawOmniInstanceWebui,
		HTTPMethod: "POST",
		HTTPPath:   "/",
	}

	if input == nil {
		input = &GetArkclawOmniInstanceWebuiInput{}
	}

	output = &GetArkclawOmniInstanceWebuiOutput{}
	req = c.newRequest(op, input, output)
...
//
// See the VOLCENGINE API reference guide for ARKCLAW's
// API operation GetArkclawOmniInstanceWebui for usage and error information.
func (c *ARKCLAW) GetArkclawOmniInstanceWebui(input *GetArkclawOmniInstanceWebuiInput) (*GetArkclawOmniInstanceWebuiOutput, error) {
	req, out := c.GetArkclawOmniInstanceWebuiRequest(input)
	return out, req.Send()
}

// GetArkclawOmniInstanceWebuiWithContext is the same as GetArkclawOmniInstanceWebui with the addition of
// the ability to pass a context and additional request options.
//
...
func (s *GetArkclawOmniInstanceWebuiInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "GetArkclawOmniInstanceWebuiInput"}
	if s.InstanceId == nil {
