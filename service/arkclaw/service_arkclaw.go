...
// ARKCLAW provides the API operation methods for making requests to
// ARKCLAW. See this package's package overview docs
// for details on the service.
//
// ARKCLAW methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *ARKCLAW {
	svc := &ARKCLAW{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ARKCLAW operation and runs any
// custom request initialization.
func (c *ARKCLAW) newRequest(op *request.Operation, params, data interface{}) *request.Request {
