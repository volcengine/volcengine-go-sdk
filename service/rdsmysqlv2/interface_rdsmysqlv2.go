...
type RDSMYSQLV2API interface {
	...
	DescribeDBInstancesForAllowListInnerCommon(*map[string]interface{}) (*map[string]interface{}, error)
	DescribeDBInstancesForAllowListInnerCommonWithContext(volcengine.Context, *map[string]interface{}, ...request.Option) (*map[string]interface{}, error)
	DescribeDBInstancesForAllowListInnerCommonRequest(*map[string]interface{}) (*request.Request, *map[string]interface{})

	DescribeDBInstancesForAllowListInner(*DescribeDBInstancesForAllowListInnerInput) (*DescribeDBInstancesForAllowListInnerOutput, error)
	DescribeDBInstancesForAllowListInnerWithContext(volcengine.Context, *DescribeDBInstancesForAllowListInnerInput, ...request.Option) (*DescribeDBInstancesForAllowListInnerOutput, error)
	DescribeDBInstancesForAllowListInnerRequest(*DescribeDBInstancesForAllowListInnerInput) (*request.Request, *DescribeDBInstancesForAllowListInnerOutput)
