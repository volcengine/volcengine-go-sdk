...
type ErrorLogForDescribeErrorLogsOutput struct {
	...
	LogLevel *string `type:"string" enum:"EnumOfLogLevelForDescribeErrorLogsOutput"`
...
const (
	// EnumOfLogLevelForDescribeErrorLogsOutputAll is a EnumOfLogLevelForDescribeErrorLogsOutput enum value
	EnumOfLogLevelForDescribeErrorLogsOutputAll = "All"

	// EnumOfLogLevelForDescribeErrorLogsOutputError is a EnumOfLogLevelForDescribeErrorLogsOutput enum value
	EnumOfLogLevelForDescribeErrorLogsOutputError = "Error"

	// EnumOfLogLevelForDescribeErrorLogsOutputNote is a EnumOfLogLevelForDescribeErrorLogsOutput enum value
	EnumOfLogLevelForDescribeErrorLogsOutputNote = "Note"

	// EnumOfLogLevelForDescribeErrorLogsOutputWarning is a EnumOfLogLevelForDescribeErrorLogsOutput enum value
	EnumOfLogLevelForDescribeErrorLogsOutputWarning = "Warning"
)
