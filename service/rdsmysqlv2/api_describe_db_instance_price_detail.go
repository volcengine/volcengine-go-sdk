...
type DescribeDBInstancePriceDetailOutput struct {
	...
	ChargeType *string `type:"string" enum:"EnumOfChargeTypeForDescribeDBInstancePriceDetailOutput"`
...
const (
	// EnumOfChargeTypeForDescribeDBInstancePriceDetailOutputNotEnabled is a EnumOfChargeTypeForDescribeDBInstancePriceDetailOutput enum value
	EnumOfChargeTypeForDescribeDBInstancePriceDetailOutputNotEnabled = "NotEnabled"

	// EnumOfChargeTypeForDescribeDBInstancePriceDetailOutputPostPaid is a EnumOfChargeTypeForDescribeDBInstancePriceDetailOutput enum value
	EnumOfChargeTypeForDescribeDBInstancePriceDetailOutputPostPaid = "PostPaid"

	// EnumOfChargeTypeForDescribeDBInstancePriceDetailOutputPrePaid is a EnumOfChargeTypeForDescribeDBInstancePriceDetailOutput enum value
	EnumOfChargeTypeForDescribeDBInstancePriceDetailOutputPrePaid = "PrePaid"
)
