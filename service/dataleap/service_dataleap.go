...
// DATALEAP provides the API operation methods for making requests to
// DATALEAP. See this package's package overview docs
// for details on the service.
//
// DATALEAP methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *DATALEAP {
	svc := &DATALEAP{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a DATALEAP operation and runs any
// custom request initialization.
func (c *DATALEAP) newRequest(op *request.Operation, params, data interface{}) *request.Request {
