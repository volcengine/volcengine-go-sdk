...
// VOLCSMS provides the API operation methods for making requests to
// VOLCSMS. See this package's package overview docs
// for details on the service.
//
// VOLCSMS methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VOLCSMS {
	svc := &VOLCSMS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VOLCSMS operation and runs any
// custom request initialization.
func (c *VOLCSMS) newRequest(op *request.Operation, params, data interface{}) *request.Request {
