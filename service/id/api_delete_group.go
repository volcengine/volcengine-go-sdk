...
//        fmt.Println(resp)
//    }
func (c *ID) DeleteGroupCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DeleteGroupCommon API operation for ID.
//
...
func (c *ID) DeleteGroupCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *ID) DeleteGroupCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteGroupCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *ID) DeleteGroupRequest(input *DeleteGroupInput) (req *request.Request, output *DeleteGroupOutput) {
	op := &request.Operation{
		Name:       opDeleteGroup,
		HTTPMethod: "POST",
		HTTPPath:   "/",
...
// DeleteGroup API operation for ID.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *ID) DeleteGroup(input *DeleteGroupInput) (*DeleteGroupOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ID) DeleteGroupWithContext(ctx volcengine.Context, input *DeleteGroupInput, opts ...request.Option) (*DeleteGroupOutput, error) {
	req, out := c.DeleteGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *DeleteGroupInput) SetGroupUid(v string) *DeleteGroupInput {
	s.GroupUid = &v
	return s
}

// SetUserPoolUid sets the UserPoolUid field's value.
func (s *DeleteGroupInput) SetUserPoolUid(v string) *DeleteGroupInput {
	s.UserPoolUid = &v
	return s
}
