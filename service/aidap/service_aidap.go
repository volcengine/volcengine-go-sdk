...
// AIDAP provides the API operation methods for making requests to
// AIDAP. See this package's package overview docs
// for details on the service.
//
// AIDAP methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *AIDAP {
	svc := &AIDAP{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a AIDAP operation and runs any
// custom request initialization.
func (c *AIDAP) newRequest(op *request.Operation, params, data interface{}) *request.Request {
