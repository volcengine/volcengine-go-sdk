...
//        fmt.Println(resp)
//    }
func (c *PRIVATEZONE) CreateCustomLineCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// CreateCustomLineCommon API operation for PRIVATE_ZONE.
//
...
func (c *PRIVATEZONE) CreateCustomLineCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *PRIVATEZONE) CreateCustomLineCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateCustomLineCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *PRIVATEZONE) CreateCustomLineRequest(input *CreateCustomLineInput) (req *request.Request, output *CreateCustomLineOutput) {
	op := &request.Operation{
...
// CreateCustomLine API operation for PRIVATE_ZONE.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *PRIVATEZONE) CreateCustomLine(input *CreateCustomLineInput) (*CreateCustomLineOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) CreateCustomLineWithContext(ctx volcengine.Context, input *CreateCustomLineInput, opts ...request.Option) (*CreateCustomLineOutput, error) {
	req, out := c.CreateCustomLineRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
