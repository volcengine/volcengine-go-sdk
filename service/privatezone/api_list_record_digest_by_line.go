...
//        fmt.Println(resp)
//    }
func (c *PRIVATEZONE) ListRecordDigestByLineCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ListRecordDigestByLineCommon API operation for PRIVATE_ZONE.
//
...
func (c *PRIVATEZONE) ListRecordDigestByLineCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *PRIVATEZONE) ListRecordDigestByLineCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListRecordDigestByLineCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *PRIVATEZONE) ListRecordDigestByLineRequest(input *ListRecordDigestByLineInput) (req *request.Request, output *ListRecordDigestByLineOutput) {
	op := &request.Operation{
...
// ListRecordDigestByLine API operation for PRIVATE_ZONE.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *PRIVATEZONE) ListRecordDigestByLine(input *ListRecordDigestByLineInput) (*ListRecordDigestByLineOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *PRIVATEZONE) ListRecordDigestByLineWithContext(ctx volcengine.Context, input *ListRecordDigestByLineInput, opts ...request.Option) (*ListRecordDigestByLineOutput, error) {
	req, out := c.ListRecordDigestByLineRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *RecordDigestForListRecordDigestByLineOutput) SetZID(v int64) *RecordDigestForListRecordDigestByLineOutput {
	s.ZID = &v
	return s
}
