...
// COZE20250601 provides the API operation methods for making requests to
// COZE20250601. See this package's package overview docs
// for details on the service.
//
// COZE20250601 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type COZE20250601 struct {
	*client.Client
}
...
const (
	ServiceName = "coze"      // Name of service.
	EndpointsID = ServiceName // ID to lookup a service endpoint with.
	ServiceID   = "coze"      // ServiceID is a unique identifer of a specific service.
)

// New create int can support ssl or region locate set
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *COZE20250601 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *COZE20250601 {
	svc := &COZE20250601{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a COZE20250601 operation and runs any
// custom request initialization.
func (c *COZE20250601) newRequest(op *request.Operation, params, data interface{}) *request.Request {
