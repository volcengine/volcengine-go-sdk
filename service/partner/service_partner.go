...
// PARTNER provides the API operation methods for making requests to
// PARTNER. See this package's package overview docs
// for details on the service.
//
// PARTNER methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *PARTNER {
	svc := &PARTNER{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a PARTNER operation and runs any
// custom request initialization.
func (c *PARTNER) newRequest(op *request.Operation, params, data interface{}) *request.Request {
