...
// TIS provides the API operation methods for making requests to
// TIS. See this package's package overview docs
// for details on the service.
//
// TIS methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *TIS {
	svc := &TIS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a TIS operation and runs any
// custom request initialization.
func (c *TIS) newRequest(op *request.Operation, params, data interface{}) *request.Request {
