...
// NA provides the API operation methods for making requests to
// NA. See this package's package overview docs
// for details on the service.
//
// NA methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *NA {
	svc := &NA{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a NA operation and runs any
// custom request initialization.
func (c *NA) newRequest(op *request.Operation, params, data interface{}) *request.Request {
