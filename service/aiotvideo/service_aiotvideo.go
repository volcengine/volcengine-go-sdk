...
// AIOTVIDEO provides the API operation methods for making requests to
// AIOTVIDEO. See this package's package overview docs
// for details on the service.
//
// AIOTVIDEO methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *AIOTVIDEO {
	svc := &AIOTVIDEO{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a AIOTVIDEO operation and runs any
// custom request initialization.
func (c *AIOTVIDEO) newRequest(op *request.Operation, params, data interface{}) *request.Request {
