...
// CLOUDDETECT20251031 provides the API operation methods for making requests to
// CLOUD_DETECT20251031. See this package's package overview docs
// for details on the service.
//
// CLOUDDETECT20251031 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type CLOUDDETECT20251031 struct {
	*client.Client
}
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *CLOUDDETECT20251031 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *CLOUDDETECT20251031 {
	svc := &CLOUDDETECT20251031{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a CLOUDDETECT20251031 operation and runs any
// custom request initialization.
func (c *CLOUDDETECT20251031) newRequest(op *request.Operation, params, data interface{}) *request.Request {
