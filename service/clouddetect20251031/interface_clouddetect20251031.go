...
// Package clouddetect20251031iface provides an interface to enable mocking the CLOUD_DETECT20251031 service client
...
// CLOUDDETECT20251031API provides an interface to enable mocking the
// clouddetect20251031.CLOUDDETECT20251031 service client's API operation,
//
//    // volcengine sdk func uses an SDK service client to make a request to
//    // CLOUD_DETECT20251031.
//    func myFunc(svc CLOUDDETECT20251031API) bool {
//        // Make svc.CreateTask request
//    }
//
//    func main() {
//        sess := session.New()
//        svc := clouddetect20251031.New(sess)
//
//        myFunc(svc)
//    }
//
type CLOUDDETECT20251031API interface {
...
var _ CLOUDDETECT20251031API = (*CLOUDDETECT20251031)(nil)
