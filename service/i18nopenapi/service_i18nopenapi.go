...
// I18NOPENAPI provides the API operation methods for making requests to
// I18N_OPENAPI. See this package's package overview docs
// for details on the service.
//
// I18NOPENAPI methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *I18NOPENAPI {
	svc := &I18NOPENAPI{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a I18NOPENAPI operation and runs any
// custom request initialization.
func (c *I18NOPENAPI) newRequest(op *request.Operation, params, data interface{}) *request.Request {
