...
const opProjectNamespaceSourceDownloadCommon = "ProjectNamespaceSourceDownload"

// ProjectNamespaceSourceDownloadCommonRequest generates a "volcengine/request.Request" representing the
// client's request for the ProjectNamespaceSourceDownloadCommon operation. The "output" return
// value will be populated with the ProjectNamespaceSourceDownloadCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned ProjectNamespaceSourceDownloadCommon Request to send the API call to the service.
// the "output" return value is not valid until after ProjectNamespaceSourceDownloadCommon Send returns without error.
//
// See ProjectNamespaceSourceDownloadCommon for more information on using the ProjectNamespaceSourceDownloadCommon
...
func (c *I18NOPENAPI) ProjectNamespaceSourceDownloadCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
	op := &request.Operation{
		Name:       opProjectNamespaceSourceDownloadCommon,
		HTTPMethod: "GET",
		HTTPPath:   "/",
	}
...
// API operation ProjectNamespaceSourceDownloadCommon for usage and error information.
func (c *I18NOPENAPI) ProjectNamespaceSourceDownloadCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
	req, out := c.ProjectNamespaceSourceDownloadCommonRequest(input)
	return out, req.Send()
}

// ProjectNamespaceSourceDownloadCommonWithContext is the same as ProjectNamespaceSourceDownloadCommon with the addition of
...
const opProjectNamespaceSourceDownload = "ProjectNamespaceSourceDownload"

// ProjectNamespaceSourceDownloadRequest generates a "volcengine/request.Request" representing the
// client's request for the ProjectNamespaceSourceDownload operation. The "output" return
// value will be populated with the ProjectNamespaceSourceDownloadCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned ProjectNamespaceSourceDownloadCommon Request to send the API call to the service.
// the "output" return value is not valid until after ProjectNamespaceSourceDownloadCommon Send returns without error.
//
// See ProjectNamespaceSourceDownload for more information on using the ProjectNamespaceSourceDownload
// API call, and error handling.
//
...
func (c *I18NOPENAPI) ProjectNamespaceSourceDownloadRequest(input *ProjectNamespaceSourceDownloadInput) (req *request.Request, output *ProjectNamespaceSourceDownloadOutput) {
	op := &request.Operation{
		Name:       opProjectNamespaceSourceDownload,
		HTTPMethod: "GET",
		HTTPPath:   "/",
	}

	if input == nil {
		input = &ProjectNamespaceSourceDownloadInput{}
	}

	output = &ProjectNamespaceSourceDownloadOutput{}
	req = c.newRequest(op, input, output)
...
//
// See the VOLCENGINE API reference guide for I18N_OPENAPI's
// API operation ProjectNamespaceSourceDownload for usage and error information.
func (c *I18NOPENAPI) ProjectNamespaceSourceDownload(input *ProjectNamespaceSourceDownloadInput) (*ProjectNamespaceSourceDownloadOutput, error) {
	req, out := c.ProjectNamespaceSourceDownloadRequest(input)
	return out, req.Send()
}

// ProjectNamespaceSourceDownloadWithContext is the same as ProjectNamespaceSourceDownload with the addition of
// the ability to pass a context and additional request options.
//
...
func (s *ProjectNamespaceSourceDownloadInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "ProjectNamespaceSourceDownloadInput"}
	if s.NamespaceId == nil {
		invalidParams.Add(request.NewErrParamRequired("NamespaceId"))
	}
	if s.PlaceHolder != nil && *s.PlaceHolder > 1 {
		invalidParams.Add(request.NewErrParamMaxValue("PlaceHolder", 1))
	}
	if s.ProjectId == nil {
