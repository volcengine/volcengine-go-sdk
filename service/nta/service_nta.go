...
// NTA provides the API operation methods for making requests to
// NTA. See this package's package overview docs
// for details on the service.
//
// NTA methods are safe to use concurrently. It is not safe to
...
const (
	ServiceName = "nta"       // Name of service.
	EndpointsID = ServiceName // ID to lookup a service endpoint with.
	ServiceID   = "nta"       // ServiceID is a unique identifer of a specific service.
)
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *NTA {
	svc := &NTA{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a NTA operation and runs any
// custom request initialization.
func (c *NTA) newRequest(op *request.Operation, params, data interface{}) *request.Request {
