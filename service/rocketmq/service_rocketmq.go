...
// ROCKETMQ provides the API operation methods for making requests to
// ROCKETMQ. See this package's package overview docs
// for details on the service.
//
// ROCKETMQ methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *ROCKETMQ {
	svc := &ROCKETMQ{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ROCKETMQ operation and runs any
// custom request initialization.
func (c *ROCKETMQ) newRequest(op *request.Operation, params, data interface{}) *request.Request {
