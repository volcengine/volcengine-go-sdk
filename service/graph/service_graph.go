...
// GRAPH provides the API operation methods for making requests to
// GRAPH. See this package's package overview docs
// for details on the service.
//
// GRAPH methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *GRAPH {
	svc := &GRAPH{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a GRAPH operation and runs any
// custom request initialization.
func (c *GRAPH) newRequest(op *request.Operation, params, data interface{}) *request.Request {
