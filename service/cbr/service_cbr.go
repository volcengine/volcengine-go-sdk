...
// CBR provides the API operation methods for making requests to
// CBR. See this package's package overview docs
// for details on the service.
//
// CBR methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *CBR {
	svc := &CBR{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a CBR operation and runs any
// custom request initialization.
func (c *CBR) newRequest(op *request.Operation, params, data interface{}) *request.Request {
