...
func (s *DescribeReservedInstancesInput) SetPageNumber(v int32) *DescribeReservedInstancesInput {
	s.PageNumber = &v
	return s
}

// SetPageSize sets the PageSize field's value.
func (s *DescribeReservedInstancesInput) SetPageSize(v int32) *DescribeReservedInstancesInput {
	s.PageSize = &v
	return s
}
...
// SetPageNumber sets the PageNumber field's value.
func (s *DescribeReservedInstancesOutput) SetPageNumber(v int32) *DescribeReservedInstancesOutput {
	s.PageNumber = &v
	return s
}

// SetPageSize sets the PageSize field's value.
func (s *DescribeReservedInstancesOutput) SetPageSize(v int32) *DescribeReservedInstancesOutput {
	s.PageSize = &v
	return s
}
...
func (s *DescribeReservedInstancesOutput) SetTotalCount(v int32) *DescribeReservedInstancesOutput {
	s.TotalCount = &v
	return s
}
