...
// DeleteScheduledInstanceCommonRequest generates a "volcengine/request.Request" representing the
...
func (c *ECS) DeleteScheduledInstanceCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteScheduledInstanceCommonRequest(input)
	req.SetContext(ctx)
...
// DeleteScheduledInstanceRequest generates a "volcengine/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS) DeleteScheduledInstanceWithContext(ctx volcengine.Context, input *DeleteScheduledInstanceInput, opts ...request.Option) (*DeleteScheduledInstanceOutput, error) {
	req, out := c.DeleteScheduledInstanceRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
