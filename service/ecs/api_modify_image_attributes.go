...
// ModifyImageAttributesCommonRequest generates a "volcengine/request.Request" representing the
...
func (c *ECS) ModifyImageAttributesCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyImageAttributesCommonRequest(input)
	req.SetContext(ctx)
...
// ModifyImageAttributesRequest generates a "volcengine/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ECS) ModifyImageAttributesWithContext(ctx volcengine.Context, input *ModifyImageAttributesInput, opts ...request.Option) (*ModifyImageAttributesOutput, error) {
	req, out := c.ModifyImageAttributesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *ModifyImageAttributesInput) SetBootMode(v string) *ModifyImageAttributesInput {
	s.BootMode = &v
	return s
}
