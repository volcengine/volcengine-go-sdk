...
func (s *ModifyInstancesSpecInput) SetNeedPreorders(v bool) *ModifyInstancesSpecInput {
	s.NeedPreorders = &v
	return s
}
...
func (s *ModifyInstancesSpecOutput) SetPreorderIds(v []*string) *ModifyInstancesSpecOutput {
	s.PreorderIds = v
	return s
}
