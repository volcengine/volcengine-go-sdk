...
//        fmt.Println(resp)
//    }
func (c *ALB) DescribeLoadBalancerSpecsCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DescribeLoadBalancerSpecsCommon API operation for ALB.
//
...
func (c *ALB) DescribeLoadBalancerSpecsCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *ALB) DescribeLoadBalancerSpecsCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeLoadBalancerSpecsCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *ALB) DescribeLoadBalancerSpecsRequest(input *DescribeLoadBalancerSpecsInput) (req *request.Request, output *DescribeLoadBalancerSpecsOutput) {
	op := &request.Operation{
...
// DescribeLoadBalancerSpecs API operation for ALB.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *ALB) DescribeLoadBalancerSpecs(input *DescribeLoadBalancerSpecsInput) (*DescribeLoadBalancerSpecsOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ALB) DescribeLoadBalancerSpecsWithContext(ctx volcengine.Context, input *DescribeLoadBalancerSpecsInput, opts ...request.Option) (*DescribeLoadBalancerSpecsOutput, error) {
	req, out := c.DescribeLoadBalancerSpecsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
