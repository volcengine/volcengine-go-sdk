...
func (s *HealthCheckTemplateForModifyHealthCheckTemplatesAttributesInput) SetHealthCheckPort(v int64) *HealthCheckTemplateForModifyHealthCheckTemplatesAttributesInput {
	s.HealthCheckPort = &v
	return s
}
