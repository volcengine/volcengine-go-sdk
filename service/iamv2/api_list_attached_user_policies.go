...
//        fmt.Println(resp)
//    }
func (c *IAMV2) ListAttachedUserPoliciesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ListAttachedUserPoliciesCommon API operation for IAMV2.
//
...
func (c *IAMV2) ListAttachedUserPoliciesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAMV2) ListAttachedUserPoliciesCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListAttachedUserPoliciesCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *IAMV2) ListAttachedUserPoliciesRequest(input *ListAttachedUserPoliciesInput) (req *request.Request, output *ListAttachedUserPoliciesOutput) {
	op := &request.Operation{
...
// ListAttachedUserPolicies API operation for IAMV2.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAMV2) ListAttachedUserPolicies(input *ListAttachedUserPoliciesInput) (*ListAttachedUserPoliciesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAMV2) ListAttachedUserPoliciesWithContext(ctx volcengine.Context, input *ListAttachedUserPoliciesInput, opts ...request.Option) (*ListAttachedUserPoliciesOutput, error) {
	req, out := c.ListAttachedUserPoliciesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
