...
//        fmt.Println(resp)
//    }
func (c *IAMV2) ListUsersForGroupCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ListUsersForGroupCommon API operation for IAMV2.
//
...
func (c *IAMV2) ListUsersForGroupCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAMV2) ListUsersForGroupCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListUsersForGroupCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *IAMV2) ListUsersForGroupRequest(input *ListUsersForGroupInput) (req *request.Request, output *ListUsersForGroupOutput) {
	op := &request.Operation{
...
// ListUsersForGroup API operation for IAMV2.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAMV2) ListUsersForGroup(input *ListUsersForGroupInput) (*ListUsersForGroupOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAMV2) ListUsersForGroupWithContext(ctx volcengine.Context, input *ListUsersForGroupInput, opts ...request.Option) (*ListUsersForGroupOutput, error) {
	req, out := c.ListUsersForGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
