...
//        fmt.Println(resp)
//    }
func (c *IAMV2) DetachUserGroupPolicyCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DetachUserGroupPolicyCommon API operation for IAMV2.
//
...
func (c *IAMV2) DetachUserGroupPolicyCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAMV2) DetachUserGroupPolicyCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DetachUserGroupPolicyCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *IAMV2) DetachUserGroupPolicyRequest(input *DetachUserGroupPolicyInput) (req *request.Request, output *DetachUserGroupPolicyOutput) {
	op := &request.Operation{
...
// DetachUserGroupPolicy API operation for IAMV2.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAMV2) DetachUserGroupPolicy(input *DetachUserGroupPolicyInput) (*DetachUserGroupPolicyOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAMV2) DetachUserGroupPolicyWithContext(ctx volcengine.Context, input *DetachUserGroupPolicyInput, opts ...request.Option) (*DetachUserGroupPolicyOutput, error) {
	req, out := c.DetachUserGroupPolicyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
