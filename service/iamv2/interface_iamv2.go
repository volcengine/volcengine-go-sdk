...
// Package iamv2iface provides an interface to enable mocking the IAMV2 service client
...
// IAMV2API provides an interface to enable mocking the
// iamv2.IAMV2 service client's API operation,
//
//    // volcengine sdk func uses an SDK service client to make a request to
//    // IAMV2.
//    func myFunc(svc IAMV2API) bool {
