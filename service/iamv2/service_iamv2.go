...
// IAMV2 provides the API operation methods for making requests to
// IAMV2. See this package's package overview docs
// for details on the service.
//
// IAMV2 methods are safe to use concurrently. It is not safe to
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *IAMV2 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *IAMV2 {
	svc := &IAMV2{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a IAMV2 operation and runs any
// custom request initialization.
func (c *IAMV2) newRequest(op *request.Operation, params, data interface{}) *request.Request {
