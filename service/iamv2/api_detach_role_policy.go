...
//        fmt.Println(resp)
//    }
func (c *IAMV2) DetachRolePolicyCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DetachRolePolicyCommon API operation for IAMV2.
//
...
func (c *IAMV2) DetachRolePolicyCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAMV2) DetachRolePolicyCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DetachRolePolicyCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *IAMV2) DetachRolePolicyRequest(input *DetachRolePolicyInput) (req *request.Request, output *DetachRolePolicyOutput) {
	op := &request.Operation{
...
// DetachRolePolicy API operation for IAMV2.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAMV2) DetachRolePolicy(input *DetachRolePolicyInput) (*DetachRolePolicyOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAMV2) DetachRolePolicyWithContext(ctx volcengine.Context, input *DetachRolePolicyInput, opts ...request.Option) (*DetachRolePolicyOutput, error) {
	req, out := c.DetachRolePolicyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
