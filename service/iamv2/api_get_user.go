...
//        fmt.Println(resp)
//    }
func (c *IAMV2) GetUserCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// GetUserCommon API operation for IAMV2.
//
...
func (c *IAMV2) GetUserCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAMV2) GetUserCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetUserCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *IAMV2) GetUserRequest(input *GetUserInput) (req *request.Request, output *GetUserOutput) {
	op := &request.Operation{
		Name:       opGetUser,
		HTTPMethod: "GET",
		HTTPPath:   "/",
...
// GetUser API operation for IAMV2.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAMV2) GetUser(input *GetUserInput) (*GetUserOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAMV2) GetUserWithContext(ctx volcengine.Context, input *GetUserInput, opts ...request.Option) (*GetUserOutput, error) {
	req, out := c.GetUserRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
