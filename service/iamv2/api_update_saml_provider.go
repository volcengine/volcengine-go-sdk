...
//        fmt.Println(resp)
//    }
func (c *IAMV2) UpdateSAMLProviderCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// UpdateSAMLProviderCommon API operation for IAMV2.
//
...
func (c *IAMV2) UpdateSAMLProviderCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAMV2) UpdateSAMLProviderCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateSAMLProviderCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *IAMV2) UpdateSAMLProviderRequest(input *UpdateSAMLProviderInput) (req *request.Request, output *UpdateSAMLProviderOutput) {
	op := &request.Operation{
...
// UpdateSAMLProvider API operation for IAMV2.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAMV2) UpdateSAMLProvider(input *UpdateSAMLProviderInput) (*UpdateSAMLProviderOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAMV2) UpdateSAMLProviderWithContext(ctx volcengine.Context, input *UpdateSAMLProviderInput, opts ...request.Option) (*UpdateSAMLProviderOutput, error) {
	req, out := c.UpdateSAMLProviderRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
