...
//        fmt.Println(resp)
//    }
func (c *IAMV2) ListAccessKeysCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ListAccessKeysCommon API operation for IAMV2.
//
...
func (c *IAMV2) ListAccessKeysCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAMV2) ListAccessKeysCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListAccessKeysCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *IAMV2) ListAccessKeysRequest(input *ListAccessKeysInput) (req *request.Request, output *ListAccessKeysOutput) {
	op := &request.Operation{
...
// ListAccessKeys API operation for IAMV2.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAMV2) ListAccessKeys(input *ListAccessKeysInput) (*ListAccessKeysOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAMV2) ListAccessKeysWithContext(ctx volcengine.Context, input *ListAccessKeysInput, opts ...request.Option) (*ListAccessKeysOutput, error) {
	req, out := c.ListAccessKeysRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
