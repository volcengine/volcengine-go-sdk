...
//        fmt.Println(resp)
//    }
func (c *IAMV2) ListAttachedRolePoliciesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ListAttachedRolePoliciesCommon API operation for IAMV2.
//
...
func (c *IAMV2) ListAttachedRolePoliciesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAMV2) ListAttachedRolePoliciesCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListAttachedRolePoliciesCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *IAMV2) ListAttachedRolePoliciesRequest(input *ListAttachedRolePoliciesInput) (req *request.Request, output *ListAttachedRolePoliciesOutput) {
	op := &request.Operation{
...
// ListAttachedRolePolicies API operation for IAMV2.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAMV2) ListAttachedRolePolicies(input *ListAttachedRolePoliciesInput) (*ListAttachedRolePoliciesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAMV2) ListAttachedRolePoliciesWithContext(ctx volcengine.Context, input *ListAttachedRolePoliciesInput, opts ...request.Option) (*ListAttachedRolePoliciesOutput, error) {
	req, out := c.ListAttachedRolePoliciesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
