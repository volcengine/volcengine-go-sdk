...
//        fmt.Println(resp)
//    }
func (c *IAMV2) UpdateRoleCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// UpdateRoleCommon API operation for IAMV2.
//
...
func (c *IAMV2) UpdateRoleCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAMV2) UpdateRoleCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateRoleCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *IAMV2) UpdateRoleRequest(input *UpdateRoleInput) (req *request.Request, output *UpdateRoleOutput) {
	op := &request.Operation{
		Name:       opUpdateRole,
		HTTPMethod: "GET",
		HTTPPath:   "/",
...
// UpdateRole API operation for IAMV2.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAMV2) UpdateRole(input *UpdateRoleInput) (*UpdateRoleOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAMV2) UpdateRoleWithContext(ctx volcengine.Context, input *UpdateRoleInput, opts ...request.Option) (*UpdateRoleOutput, error) {
	req, out := c.UpdateRoleRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
