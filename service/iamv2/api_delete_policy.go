...
//        fmt.Println(resp)
//    }
func (c *IAMV2) DeletePolicyCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DeletePolicyCommon API operation for IAMV2.
//
...
func (c *IAMV2) DeletePolicyCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *IAMV2) DeletePolicyCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeletePolicyCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *IAMV2) DeletePolicyRequest(input *DeletePolicyInput) (req *request.Request, output *DeletePolicyOutput) {
	op := &request.Operation{
		Name:       opDeletePolicy,
		HTTPMethod: "GET",
		HTTPPath:   "/",
...
// DeletePolicy API operation for IAMV2.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *IAMV2) DeletePolicy(input *DeletePolicyInput) (*DeletePolicyOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *IAMV2) DeletePolicyWithContext(ctx volcengine.Context, input *DeletePolicyInput, opts ...request.Option) (*DeletePolicyOutput, error) {
	req, out := c.DeletePolicyRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
