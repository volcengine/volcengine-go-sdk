...
const opDescribeAvailableZonesCommon = "DescribeAvailableZones"

// DescribeAvailableZonesCommonRequest generates a "volcengine/request.Request" representing the
// client's request for the DescribeAvailableZonesCommon operation. The "output" return
// value will be populated with the DescribeAvailableZonesCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned DescribeAvailableZonesCommon Request to send the API call to the service.
// the "output" return value is not valid until after DescribeAvailableZonesCommon Send returns without error.
//
// See DescribeAvailableZonesCommon for more information on using the DescribeAvailableZonesCommon
...
func (c *BMQ) DescribeAvailableZonesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
	op := &request.Operation{
		Name:       opDescribeAvailableZonesCommon,
		HTTPMethod: "POST",
		HTTPPath:   "/",
	}
...
// API operation DescribeAvailableZonesCommon for usage and error information.
func (c *BMQ) DescribeAvailableZonesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
	req, out := c.DescribeAvailableZonesCommonRequest(input)
	return out, req.Send()
}

// DescribeAvailableZonesCommonWithContext is the same as DescribeAvailableZonesCommon with the addition of
...
const opDescribeAvailableZones = "DescribeAvailableZones"

// DescribeAvailableZonesRequest generates a "volcengine/request.Request" representing the
// client's request for the DescribeAvailableZones operation. The "output" return
// value will be populated with the DescribeAvailableZonesCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned DescribeAvailableZonesCommon Request to send the API call to the service.
// the "output" return value is not valid until after DescribeAvailableZonesCommon Send returns without error.
//
// See DescribeAvailableZones for more information on using the DescribeAvailableZones
// API call, and error handling.
//
...
func (c *BMQ) DescribeAvailableZonesRequest(input *DescribeAvailableZonesInput) (req *request.Request, output *DescribeAvailableZonesOutput) {
	op := &request.Operation{
		Name:       opDescribeAvailableZones,
		HTTPMethod: "POST",
		HTTPPath:   "/",
	}

	if input == nil {
		input = &DescribeAvailableZonesInput{}
	}

	output = &DescribeAvailableZonesOutput{}
	req = c.newRequest(op, input, output)
...
//
// See the VOLCENGINE API reference guide for BMQ's
// API operation DescribeAvailableZones for usage and error information.
func (c *BMQ) DescribeAvailableZones(input *DescribeAvailableZonesInput) (*DescribeAvailableZonesOutput, error) {
	req, out := c.DescribeAvailableZonesRequest(input)
	return out, req.Send()
}

// DescribeAvailableZonesWithContext is the same as DescribeAvailableZones with the addition of
// the ability to pass a context and additional request options.
//
...
func (s *DescribeAvailableZonesInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "DescribeAvailableZonesInput"}
