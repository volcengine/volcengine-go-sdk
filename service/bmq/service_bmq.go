...
// BMQ provides the API operation methods for making requests to
// BMQ. See this package's package overview docs
// for details on the service.
//
// BMQ methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *BMQ {
	svc := &BMQ{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a BMQ operation and runs any
// custom request initialization.
func (c *BMQ) newRequest(op *request.Operation, params, data interface{}) *request.Request {
