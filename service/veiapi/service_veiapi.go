...
// VEIAPI provides the API operation methods for making requests to
// VEI_API. See this package's package overview docs
// for details on the service.
//
// VEIAPI methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VEIAPI {
	svc := &VEIAPI{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VEIAPI operation and runs any
// custom request initialization.
func (c *VEIAPI) newRequest(op *request.Operation, params, data interface{}) *request.Request {
