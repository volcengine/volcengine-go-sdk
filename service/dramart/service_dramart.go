...
// DRAMART provides the API operation methods for making requests to
// DRAMART. See this package's package overview docs
// for details on the service.
//
// DRAMART methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *DRAMART {
	svc := &DRAMART{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a DRAMART operation and runs any
// custom request initialization.
func (c *DRAMART) newRequest(op *request.Operation, params, data interface{}) *request.Request {
