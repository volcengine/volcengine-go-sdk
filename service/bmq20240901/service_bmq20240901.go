...
// BMQ20240901 provides the API operation methods for making requests to
// BMQ20240901. See this package's package overview docs
// for details on the service.
//
// BMQ20240901 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type BMQ20240901 struct {
	*client.Client
}
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *BMQ20240901 {
	svc := &BMQ20240901{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a BMQ20240901 operation and runs any
// custom request initialization.
func (c *BMQ20240901) newRequest(op *request.Operation, params, data interface{}) *request.Request {
