...
func (s *TrailForDescribeTrailsOutput) SetTlsAccountId(v string) *TrailForDescribeTrailsOutput {
	s.TlsAccountId = &v
	return s
}
...
func (s *TrailForDescribeTrailsOutput) SetTlsWriteRoleTrn(v string) *TrailForDescribeTrailsOutput {
	s.TlsWriteRoleTrn = &v
	return s
}

// SetTosAccountId sets the TosAccountId field's value.
func (s *TrailForDescribeTrailsOutput) SetTosAccountId(v string) *TrailForDescribeTrailsOutput {
	s.TosAccountId = &v
	return s
}
...
func (s *TrailForDescribeTrailsOutput) SetTosSSEAlgorithm(v string) *TrailForDescribeTrailsOutput {
	s.TosSSEAlgorithm = &v
	return s
}

// SetTosSSEKMSKeyID sets the TosSSEKMSKeyID field's value.
func (s *TrailForDescribeTrailsOutput) SetTosSSEKMSKeyID(v string) *TrailForDescribeTrailsOutput {
	s.TosSSEKMSKeyID = &v
	return s
}

// SetTosWriteRoleTrn sets the TosWriteRoleTrn field's value.
func (s *TrailForDescribeTrailsOutput) SetTosWriteRoleTrn(v string) *TrailForDescribeTrailsOutput {
	s.TosWriteRoleTrn = &v
	return s
}
