...
// BIO provides the API operation methods for making requests to
// BIO. See this package's package overview docs
// for details on the service.
//
// BIO methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *BIO {
	svc := &BIO{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a BIO operation and runs any
// custom request initialization.
func (c *BIO) newRequest(op *request.Operation, params, data interface{}) *request.Request {
