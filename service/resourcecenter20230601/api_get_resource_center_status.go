...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) GetResourceCenterStatusCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// GetResourceCenterStatusCommon API operation for RESOURCECENTER20230601.
//
...
func (c *RESOURCECENTER20230601) GetResourceCenterStatusCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *RESOURCECENTER20230601) GetResourceCenterStatusCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetResourceCenterStatusCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) GetResourceCenterStatusRequest(input *GetResourceCenterStatusInput) (req *request.Request, output *GetResourceCenterStatusOutput) {
	op := &request.Operation{
...
// GetResourceCenterStatus API operation for RESOURCECENTER20230601.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *RESOURCECENTER20230601) GetResourceCenterStatus(input *GetResourceCenterStatusInput) (*GetResourceCenterStatusOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RESOURCECENTER20230601) GetResourceCenterStatusWithContext(ctx volcengine.Context, input *GetResourceCenterStatusInput, opts ...request.Option) (*GetResourceCenterStatusOutput, error) {
	req, out := c.GetResourceCenterStatusRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
