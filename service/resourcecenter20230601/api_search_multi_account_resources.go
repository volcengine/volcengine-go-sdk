...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) SearchMultiAccountResourcesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// SearchMultiAccountResourcesCommon API operation for RESOURCECENTER20230601.
//
...
func (c *RESOURCECENTER20230601) SearchMultiAccountResourcesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *RESOURCECENTER20230601) SearchMultiAccountResourcesCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SearchMultiAccountResourcesCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) SearchMultiAccountResourcesRequest(input *SearchMultiAccountResourcesInput) (req *request.Request, output *SearchMultiAccountResourcesOutput) {
	op := &request.Operation{
...
// SearchMultiAccountResources API operation for RESOURCECENTER20230601.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *RESOURCECENTER20230601) SearchMultiAccountResources(input *SearchMultiAccountResourcesInput) (*SearchMultiAccountResourcesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RESOURCECENTER20230601) SearchMultiAccountResourcesWithContext(ctx volcengine.Context, input *SearchMultiAccountResourcesInput, opts ...request.Option) (*SearchMultiAccountResourcesOutput, error) {
	req, out := c.SearchMultiAccountResourcesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
