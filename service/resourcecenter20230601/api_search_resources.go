...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) SearchResourcesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// SearchResourcesCommon API operation for RESOURCECENTER20230601.
//
...
func (c *RESOURCECENTER20230601) SearchResourcesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *RESOURCECENTER20230601) SearchResourcesCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SearchResourcesCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) SearchResourcesRequest(input *SearchResourcesInput) (req *request.Request, output *SearchResourcesOutput) {
	op := &request.Operation{
...
// SearchResources API operation for RESOURCECENTER20230601.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *RESOURCECENTER20230601) SearchResources(input *SearchResourcesInput) (*SearchResourcesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RESOURCECENTER20230601) SearchResourcesWithContext(ctx volcengine.Context, input *SearchResourcesInput, opts ...request.Option) (*SearchResourcesOutput, error) {
	req, out := c.SearchResourcesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
