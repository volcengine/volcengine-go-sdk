...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) GetResourceCountsCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// GetResourceCountsCommon API operation for RESOURCECENTER20230601.
//
...
func (c *RESOURCECENTER20230601) GetResourceCountsCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *RESOURCECENTER20230601) GetResourceCountsCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetResourceCountsCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) GetResourceCountsRequest(input *GetResourceCountsInput) (req *request.Request, output *GetResourceCountsOutput) {
	op := &request.Operation{
...
// GetResourceCounts API operation for RESOURCECENTER20230601.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *RESOURCECENTER20230601) GetResourceCounts(input *GetResourceCountsInput) (*GetResourceCountsOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RESOURCECENTER20230601) GetResourceCountsWithContext(ctx volcengine.Context, input *GetResourceCountsInput, opts ...request.Option) (*GetResourceCountsOutput, error) {
	req, out := c.GetResourceCountsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
