...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) ListResourceTypesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ListResourceTypesCommon API operation for RESOURCECENTER20230601.
//
...
func (c *RESOURCECENTER20230601) ListResourceTypesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *RESOURCECENTER20230601) ListResourceTypesCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListResourceTypesCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) ListResourceTypesRequest(input *ListResourceTypesInput) (req *request.Request, output *ListResourceTypesOutput) {
	op := &request.Operation{
...
// ListResourceTypes API operation for RESOURCECENTER20230601.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *RESOURCECENTER20230601) ListResourceTypes(input *ListResourceTypesInput) (*ListResourceTypesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RESOURCECENTER20230601) ListResourceTypesWithContext(ctx volcengine.Context, input *ListResourceTypesInput, opts ...request.Option) (*ListResourceTypesOutput, error) {
	req, out := c.ListResourceTypesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
