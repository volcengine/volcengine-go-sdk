...
// RESOURCECENTER20230601 provides the API operation methods for making requests to
// RESOURCECENTER20230601. See this package's package overview docs
// for details on the service.
//
// RESOURCECENTER20230601 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type RESOURCECENTER20230601 struct {
	*client.Client
}
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *RESOURCECENTER20230601 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *RESOURCECENTER20230601 {
	svc := &RESOURCECENTER20230601{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a RESOURCECENTER20230601 operation and runs any
// custom request initialization.
func (c *RESOURCECENTER20230601) newRequest(op *request.Operation, params, data interface{}) *request.Request {
