...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) GetMultiAccountResourceCountsCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// GetMultiAccountResourceCountsCommon API operation for RESOURCECENTER20230601.
//
...
func (c *RESOURCECENTER20230601) GetMultiAccountResourceCountsCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *RESOURCECENTER20230601) GetMultiAccountResourceCountsCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.GetMultiAccountResourceCountsCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) GetMultiAccountResourceCountsRequest(input *GetMultiAccountResourceCountsInput) (req *request.Request, output *GetMultiAccountResourceCountsOutput) {
	op := &request.Operation{
...
// GetMultiAccountResourceCounts API operation for RESOURCECENTER20230601.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *RESOURCECENTER20230601) GetMultiAccountResourceCounts(input *GetMultiAccountResourceCountsInput) (*GetMultiAccountResourceCountsOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RESOURCECENTER20230601) GetMultiAccountResourceCountsWithContext(ctx volcengine.Context, input *GetMultiAccountResourceCountsInput, opts ...request.Option) (*GetMultiAccountResourceCountsOutput, error) {
	req, out := c.GetMultiAccountResourceCountsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
