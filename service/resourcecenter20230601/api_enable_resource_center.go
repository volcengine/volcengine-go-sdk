...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) EnableResourceCenterCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// EnableResourceCenterCommon API operation for RESOURCECENTER20230601.
//
...
func (c *RESOURCECENTER20230601) EnableResourceCenterCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *RESOURCECENTER20230601) EnableResourceCenterCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.EnableResourceCenterCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *RESOURCECENTER20230601) EnableResourceCenterRequest(input *EnableResourceCenterInput) (req *request.Request, output *EnableResourceCenterOutput) {
	op := &request.Operation{
...
// EnableResourceCenter API operation for RESOURCECENTER20230601.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *RESOURCECENTER20230601) EnableResourceCenter(input *EnableResourceCenterInput) (*EnableResourceCenterOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *RESOURCECENTER20230601) EnableResourceCenterWithContext(ctx volcengine.Context, input *EnableResourceCenterInput, opts ...request.Option) (*EnableResourceCenterOutput, error) {
	req, out := c.EnableResourceCenterRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
