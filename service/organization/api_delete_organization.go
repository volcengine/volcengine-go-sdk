...
const opDeleteOrganizationCommon = "DeleteOrganization"

// DeleteOrganizationCommonRequest generates a "volcengine/request.Request" representing the
// client's request for the DeleteOrganizationCommon operation. The "output" return
// value will be populated with the DeleteOrganizationCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned DeleteOrganizationCommon Request to send the API call to the service.
// the "output" return value is not valid until after DeleteOrganizationCommon Send returns without error.
//
// See DeleteOrganizationCommon for more information on using the DeleteOrganizationCommon
...
func (c *ORGANIZATION) DeleteOrganizationCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
	op := &request.Operation{
		Name:       opDeleteOrganizationCommon,
		HTTPMethod: "POST",
		HTTPPath:   "/",
	}
...
// API operation DeleteOrganizationCommon for usage and error information.
func (c *ORGANIZATION) DeleteOrganizationCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
	req, out := c.DeleteOrganizationCommonRequest(input)
	return out, req.Send()
}

// DeleteOrganizationCommonWithContext is the same as DeleteOrganizationCommon with the addition of
...
// DeleteOrganizationRequest generates a "volcengine/request.Request" representing the
