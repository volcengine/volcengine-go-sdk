...
// ORGANIZATION provides the API operation methods for making requests to
// ORGANIZATION. See this package's package overview docs
// for details on the service.
//
// ORGANIZATION methods are safe to use concurrently. It is not safe to
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *ORGANIZATION {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *ORGANIZATION {
	svc := &ORGANIZATION{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ORGANIZATION operation and runs any
// custom request initialization.
func (c *ORGANIZATION) newRequest(op *request.Operation, params, data interface{}) *request.Request {
