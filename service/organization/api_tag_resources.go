...
//        fmt.Println(resp)
//    }
func (c *ORGANIZATION) TagResourcesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// TagResourcesCommon API operation for ORGANIZATION.
//
...
func (c *ORGANIZATION) TagResourcesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *ORGANIZATION) TagResourcesCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.TagResourcesCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *ORGANIZATION) TagResourcesRequest(input *TagResourcesInput) (req *request.Request, output *TagResourcesOutput) {
	op := &request.Operation{
		Name:       opTagResources,
		HTTPMethod: "GET",
		HTTPPath:   "/",
...
// TagResources API operation for ORGANIZATION.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *ORGANIZATION) TagResources(input *TagResourcesInput) (*TagResourcesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *ORGANIZATION) TagResourcesWithContext(ctx volcengine.Context, input *TagResourcesInput, opts ...request.Option) (*TagResourcesOutput, error) {
	req, out := c.TagResourcesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
type TagForTagResourcesInput struct {
	...
	Key *string `min:"1" max:"128" type:"string" required:"true"`

	// Value is a required field
	Value *string `max:"256" type:"string" required:"true"`
}
...
const (
	// EnumOfResourceTypeForTagResourcesInputAccount is a EnumOfResourceTypeForTagResourcesInput enum value
	EnumOfResourceTypeForTagResourcesInputAccount = "account"

	// EnumOfResourceTypeForTagResourcesInputUnit is a EnumOfResourceTypeForTagResourcesInput enum value
	EnumOfResourceTypeForTagResourcesInputUnit = "unit"
)
