...
// DATALEAP20260301 provides the API operation methods for making requests to
// DATALEAP20260301. See this package's package overview docs
// for details on the service.
//
// DATALEAP20260301 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type DATALEAP20260301 struct {
	*client.Client
}
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *DATALEAP20260301 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *DATALEAP20260301 {
	svc := &DATALEAP20260301{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a DATALEAP20260301 operation and runs any
// custom request initialization.
func (c *DATALEAP20260301) newRequest(op *request.Operation, params, data interface{}) *request.Request {
