...
func (c *RDSPOSTGRESQL) ModifyDBInstanceMaintenanceWindow(input *ModifyDBInstanceMaintenanceWindowInput) (*ModifyDBInstanceMaintenanceWindowOutput, error) {
...
func (s DayOfWeekMaintenanceTimeForModifyDBInstanceMaintenanceWindowInput) String() string {
	return volcengineutil.Prettify(s)
}

// GoString returns the string representation
func (s DayOfWeekMaintenanceTimeForModifyDBInstanceMaintenanceWindowInput) GoString() string {
	return s.String()
}

// SetDayOfWeek sets the DayOfWeek field's value.
func (s *DayOfWeekMaintenanceTimeForModifyDBInstanceMaintenanceWindowInput) SetDayOfWeek(v string) *DayOfWeekMaintenanceTimeForModifyDBInstanceMaintenanceWindowInput {
	s.DayOfWeek = &v
	return s
}

// SetMaintenanceWindowStartTime sets the MaintenanceWindowStartTime field's value.
func (s *DayOfWeekMaintenanceTimeForModifyDBInstanceMaintenanceWindowInput) SetMaintenanceWindowStartTime(v string) *DayOfWeekMaintenanceTimeForModifyDBInstanceMaintenanceWindowInput {
	s.MaintenanceWindowStartTime = &v
	return s
}

// SetPeriod sets the Period field's value.
func (s *DayOfWeekMaintenanceTimeForModifyDBInstanceMaintenanceWindowInput) SetPeriod(v int32) *DayOfWeekMaintenanceTimeForModifyDBInstanceMaintenanceWindowInput {
	s.Period = &v
	return s
}
...
func (s *ModifyDBInstanceMaintenanceWindowInput) Validate() error {
	...
	if s.DayKind == nil {
		invalidParams.Add(request.NewErrParamRequired("DayKind"))
	}
	if s.InstanceId == nil {
...
func (s *ModifyDBInstanceMaintenanceWindowInput) SetDayOfWeekMaintenanceTime(v []*DayOfWeekMaintenanceTimeForModifyDBInstanceMaintenanceWindowInput) *ModifyDBInstanceMaintenanceWindowInput {
