...
func (s *TemplateInfoForListParameterTemplatesOutput) SetParameterNum(v int32) *TemplateInfoForListParameterTemplatesOutput {
	s.ParameterNum = &v
	return s
}
...
func (s *TemplateParamForListParameterTemplatesOutput) SetCheckingCode(v string) *TemplateParamForListParameterTemplatesOutput {
	s.CheckingCode = &v
	return s
}
...
func (s *TemplateParamForListParameterTemplatesOutput) SetDescriptionZH(v string) *TemplateParamForListParameterTemplatesOutput {
	s.DescriptionZH = &v
	return s
}

// SetForceRestart sets the ForceRestart field's value.
func (s *TemplateParamForListParameterTemplatesOutput) SetForceRestart(v bool) *TemplateParamForListParameterTemplatesOutput {
	s.ForceRestart = &v
	return s
}
...
func (s *TemplateParamForListParameterTemplatesOutput) SetType(v string) *TemplateParamForListParameterTemplatesOutput {
	s.Type = &v
	return s
}

// SetValue sets the Value field's value.
func (s *TemplateParamForListParameterTemplatesOutput) SetValue(v string) *TemplateParamForListParameterTemplatesOutput {
	s.Value = &v
	return s
}
