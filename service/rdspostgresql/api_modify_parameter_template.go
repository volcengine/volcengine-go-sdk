...
func (s *TemplateParamForModifyParameterTemplateInput) SetCheckingCode(v string) *TemplateParamForModifyParameterTemplateInput {
	s.CheckingCode = &v
	return s
}
...
func (s *TemplateParamForModifyParameterTemplateInput) SetDescriptionZH(v string) *TemplateParamForModifyParameterTemplateInput {
	s.DescriptionZH = &v
	return s
}

// SetForceRestart sets the ForceRestart field's value.
func (s *TemplateParamForModifyParameterTemplateInput) SetForceRestart(v bool) *TemplateParamForModifyParameterTemplateInput {
	s.ForceRestart = &v
	return s
}
...
func (s *TemplateParamForModifyParameterTemplateInput) SetType(v string) *TemplateParamForModifyParameterTemplateInput {
	s.Type = &v
	return s
}

// SetValue sets the Value field's value.
func (s *TemplateParamForModifyParameterTemplateInput) SetValue(v string) *TemplateParamForModifyParameterTemplateInput {
	s.Value = &v
	return s
}
