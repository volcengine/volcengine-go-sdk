...
// DMS20250101 provides the API operation methods for making requests to
// DMS20250101. See this package's package overview docs
// for details on the service.
//
// DMS20250101 methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *DMS20250101 {
	svc := &DMS20250101{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a DMS20250101 operation and runs any
// custom request initialization.
func (c *DMS20250101) newRequest(op *request.Operation, params, data interface{}) *request.Request {
