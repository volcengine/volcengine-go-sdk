...
// LLMSCAN provides the API operation methods for making requests to
// LLMSCAN. See this package's package overview docs
// for details on the service.
//
// LLMSCAN methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *LLMSCAN {
	svc := &LLMSCAN{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a LLMSCAN operation and runs any
// custom request initialization.
func (c *LLMSCAN) newRequest(op *request.Operation, params, data interface{}) *request.Request {
