...
func (s *NoDataForUpdateAlertTemplateInput) SetEvaluationCount(v int64) *NoDataForUpdateAlertTemplateInput {
	s.EvaluationCount = &v
	return s
}
...
// SetEvaluationCount sets the EvaluationCount field's value.
func (s *TemplateRuleForUpdateAlertTemplateInput) SetEvaluationCount(v int64) *TemplateRuleForUpdateAlertTemplateInput {
	s.EvaluationCount = &v
	return s
}
...
func (s *UpdateAlertTemplateInput) SetSilenceTime(v int64) *UpdateAlertTemplateInput {
	s.SilenceTime = &v
	return s
}
