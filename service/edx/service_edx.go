...
// EDX provides the API operation methods for making requests to
// EDX. See this package's package overview docs
// for details on the service.
//
// EDX methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *EDX {
	svc := &EDX{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a EDX operation and runs any
// custom request initialization.
func (c *EDX) newRequest(op *request.Operation, params, data interface{}) *request.Request {
