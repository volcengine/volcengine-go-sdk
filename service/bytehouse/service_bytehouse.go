...
// BYTEHOUSE provides the API operation methods for making requests to
// BYTEHOUSE. See this package's package overview docs
// for details on the service.
//
// BYTEHOUSE methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type BYTEHOUSE struct {
	*client.Client
}
...
const (
	ServiceName = "bytehouse" // Name of service.
	EndpointsID = ServiceName // ID to lookup a service endpoint with.
	ServiceID   = "bytehouse" // ServiceID is a unique identifer of a specific service.
)
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *BYTEHOUSE {
	svc := &BYTEHOUSE{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a BYTEHOUSE operation and runs any
// custom request initialization.
func (c *BYTEHOUSE) newRequest(op *request.Operation, params, data interface{}) *request.Request {
