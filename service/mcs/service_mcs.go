...
// MCS provides the API operation methods for making requests to
// MCS. See this package's package overview docs
// for details on the service.
//
// MCS methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *MCS {
	svc := &MCS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a MCS operation and runs any
// custom request initialization.
func (c *MCS) newRequest(op *request.Operation, params, data interface{}) *request.Request {
