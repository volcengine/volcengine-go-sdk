...
// CLOUDCONTROL provides the API operation methods for making requests to
// CLOUDCONTROL. See this package's package overview docs
// for details on the service.
//
// CLOUDCONTROL methods are safe to use concurrently. It is not safe to
...
// newRequest creates a new request for a CLOUDCONTROL operation and runs any
