...
// SECAGENT provides the API operation methods for making requests to
// SEC_AGENT. See this package's package overview docs
// for details on the service.
//
// SECAGENT methods are safe to use concurrently. It is not safe to
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *SECAGENT {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *SECAGENT {
	svc := &SECAGENT{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a SECAGENT operation and runs any
// custom request initialization.
func (c *SECAGENT) newRequest(op *request.Operation, params, data interface{}) *request.Request {
