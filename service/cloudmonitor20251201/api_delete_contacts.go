...
//        fmt.Println(resp)
//    }
func (c *CLOUDMONITOR20251201) DeleteContactsCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DeleteContactsCommon API operation for CLOUDMONITOR20251201.
//
...
func (c *CLOUDMONITOR20251201) DeleteContactsCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *CLOUDMONITOR20251201) DeleteContactsCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteContactsCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *CLOUDMONITOR20251201) DeleteContactsRequest(input *DeleteContactsInput) (req *request.Request, output *DeleteContactsOutput) {
	op := &request.Operation{
...
// DeleteContacts API operation for CLOUDMONITOR20251201.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *CLOUDMONITOR20251201) DeleteContacts(input *DeleteContactsInput) (*DeleteContactsOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR20251201) DeleteContactsWithContext(ctx volcengine.Context, input *DeleteContactsInput, opts ...request.Option) (*DeleteContactsOutput, error) {
	req, out := c.DeleteContactsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *DeleteContactsOutput) SetData(v []*string) *DeleteContactsOutput {
	s.Data = v
	return s
}
