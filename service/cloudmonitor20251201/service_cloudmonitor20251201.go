...
// CLOUDMONITOR20251201 provides the API operation methods for making requests to
// CLOUDMONITOR20251201. See this package's package overview docs
// for details on the service.
//
// CLOUDMONITOR20251201 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type CLOUDMONITOR20251201 struct {
	*client.Client
}
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *CLOUDMONITOR20251201 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *CLOUDMONITOR20251201 {
	svc := &CLOUDMONITOR20251201{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a CLOUDMONITOR20251201 operation and runs any
// custom request initialization.
func (c *CLOUDMONITOR20251201) newRequest(op *request.Operation, params, data interface{}) *request.Request {
