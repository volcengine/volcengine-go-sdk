...
//        fmt.Println(resp)
//    }
func (c *CLOUDMONITOR20251201) EnableSilencePoliciesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// EnableSilencePoliciesCommon API operation for CLOUDMONITOR20251201.
//
...
func (c *CLOUDMONITOR20251201) EnableSilencePoliciesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *CLOUDMONITOR20251201) EnableSilencePoliciesCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.EnableSilencePoliciesCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *CLOUDMONITOR20251201) EnableSilencePoliciesRequest(input *EnableSilencePoliciesInput) (req *request.Request, output *EnableSilencePoliciesOutput) {
	op := &request.Operation{
...
// EnableSilencePolicies API operation for CLOUDMONITOR20251201.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *CLOUDMONITOR20251201) EnableSilencePolicies(input *EnableSilencePoliciesInput) (*EnableSilencePoliciesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR20251201) EnableSilencePoliciesWithContext(ctx volcengine.Context, input *EnableSilencePoliciesInput, opts ...request.Option) (*EnableSilencePoliciesOutput, error) {
	req, out := c.EnableSilencePoliciesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *EnableSilencePoliciesOutput) SetData(v []*string) *EnableSilencePoliciesOutput {
	s.Data = v
	return s
}
