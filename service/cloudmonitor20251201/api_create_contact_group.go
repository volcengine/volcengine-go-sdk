...
//        fmt.Println(resp)
//    }
func (c *CLOUDMONITOR20251201) CreateContactGroupCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// CreateContactGroupCommon API operation for CLOUDMONITOR20251201.
//
...
func (c *CLOUDMONITOR20251201) CreateContactGroupCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *CLOUDMONITOR20251201) CreateContactGroupCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateContactGroupCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *CLOUDMONITOR20251201) CreateContactGroupRequest(input *CreateContactGroupInput) (req *request.Request, output *CreateContactGroupOutput) {
	op := &request.Operation{
...
// CreateContactGroup API operation for CLOUDMONITOR20251201.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *CLOUDMONITOR20251201) CreateContactGroup(input *CreateContactGroupInput) (*CreateContactGroupOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR20251201) CreateContactGroupWithContext(ctx volcengine.Context, input *CreateContactGroupInput, opts ...request.Option) (*CreateContactGroupOutput, error) {
	req, out := c.CreateContactGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
