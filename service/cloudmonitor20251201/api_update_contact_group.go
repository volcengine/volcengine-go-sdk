...
//        fmt.Println(resp)
//    }
func (c *CLOUDMONITOR20251201) UpdateContactGroupCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// UpdateContactGroupCommon API operation for CLOUDMONITOR20251201.
//
...
func (c *CLOUDMONITOR20251201) UpdateContactGroupCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *CLOUDMONITOR20251201) UpdateContactGroupCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateContactGroupCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *CLOUDMONITOR20251201) UpdateContactGroupRequest(input *UpdateContactGroupInput) (req *request.Request, output *UpdateContactGroupOutput) {
	op := &request.Operation{
...
// UpdateContactGroup API operation for CLOUDMONITOR20251201.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *CLOUDMONITOR20251201) UpdateContactGroup(input *UpdateContactGroupInput) (*UpdateContactGroupOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR20251201) UpdateContactGroupWithContext(ctx volcengine.Context, input *UpdateContactGroupInput, opts ...request.Option) (*UpdateContactGroupOutput, error) {
	req, out := c.UpdateContactGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
