...
// CreateSharedDirectConnectConnectionCommonRequest generates a "volcengine/request.Request" representing the
...
func (c *DIRECTCONNECT) CreateSharedDirectConnectConnectionCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateSharedDirectConnectConnectionCommonRequest(input)
	req.SetContext(ctx)
...
// CreateSharedDirectConnectConnectionRequest generates a "volcengine/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *DIRECTCONNECT) CreateSharedDirectConnectConnectionWithContext(ctx volcengine.Context, input *CreateSharedDirectConnectConnectionInput, opts ...request.Option) (*CreateSharedDirectConnectConnectionOutput, error) {
	req, out := c.CreateSharedDirectConnectConnectionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
