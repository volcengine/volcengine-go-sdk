...
// ConfirmDirectConnectConnectionCommonRequest generates a "volcengine/request.Request" representing the
...
func (c *DIRECTCONNECT) ConfirmDirectConnectConnectionCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ConfirmDirectConnectConnectionCommonRequest(input)
	req.SetContext(ctx)
...
// ConfirmDirectConnectConnectionRequest generates a "volcengine/request.Request" representing the
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *DIRECTCONNECT) ConfirmDirectConnectConnectionWithContext(ctx volcengine.Context, input *ConfirmDirectConnectConnectionInput, opts ...request.Option) (*ConfirmDirectConnectConnectionOutput, error) {
	req, out := c.ConfirmDirectConnectConnectionRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
