...
func (s *SharedDirectConnectConnectionForDescribeSharedDirectConnectConnectionsOutput) SetDirectConnectAccessPointId(v string) *SharedDirectConnectConnectionForDescribeSharedDirectConnectConnectionsOutput {
	s.DirectConnectAccessPointId = &v
	return s
}

// SetExpectBandwidth sets the ExpectBandwidth field's value.
func (s *SharedDirectConnectConnectionForDescribeSharedDirectConnectConnectionsOutput) SetExpectBandwidth(v int64) *SharedDirectConnectConnectionForDescribeSharedDirectConnectConnectionsOutput {
	s.ExpectBandwidth = &v
	return s
}
