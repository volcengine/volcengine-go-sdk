...
// INSIGHT provides the API operation methods for making requests to
// INSIGHT. See this package's package overview docs
// for details on the service.
//
// INSIGHT methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *INSIGHT {
	svc := &INSIGHT{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a INSIGHT operation and runs any
// custom request initialization.
func (c *INSIGHT) newRequest(op *request.Operation, params, data interface{}) *request.Request {
