...
// ADVDEFENCE provides the API operation methods for making requests to
// ADVDEFENCE. See this package's package overview docs
// for details on the service.
//
// ADVDEFENCE methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *ADVDEFENCE {
	svc := &ADVDEFENCE{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a ADVDEFENCE operation and runs any
// custom request initialization.
func (c *ADVDEFENCE) newRequest(op *request.Operation, params, data interface{}) *request.Request {
