...
// VMS provides the API operation methods for making requests to
// VMS. See this package's package overview docs
// for details on the service.
//
// VMS methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VMS {
	svc := &VMS{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VMS operation and runs any
// custom request initialization.
func (c *VMS) newRequest(op *request.Operation, params, data interface{}) *request.Request {
