...
// GTM provides the API operation methods for making requests to
// GTM. See this package's package overview docs
// for details on the service.
//
// GTM methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *GTM {
	svc := &GTM{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a GTM operation and runs any
// custom request initialization.
func (c *GTM) newRequest(op *request.Operation, params, data interface{}) *request.Request {
