...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *CLAWSENTRY {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *CLAWSENTRY {
	svc := &CLAWSENTRY{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
