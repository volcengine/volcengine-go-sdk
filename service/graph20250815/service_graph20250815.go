...
// GRAPH20250815 provides the API operation methods for making requests to
// GRAPH20250815. See this package's package overview docs
// for details on the service.
//
// GRAPH20250815 methods are safe to use concurrently. It is not safe to
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *GRAPH20250815 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *GRAPH20250815 {
	svc := &GRAPH20250815{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a GRAPH20250815 operation and runs any
// custom request initialization.
func (c *GRAPH20250815) newRequest(op *request.Operation, params, data interface{}) *request.Request {
