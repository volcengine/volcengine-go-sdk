...
// TRANSLATE20250301 provides the API operation methods for making requests to
// TRANSLATE20250301. See this package's package overview docs
// for details on the service.
//
// TRANSLATE20250301 methods are safe to use concurrently. It is not safe to
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *TRANSLATE20250301 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *TRANSLATE20250301 {
	svc := &TRANSLATE20250301{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a TRANSLATE20250301 operation and runs any
// custom request initialization.
func (c *TRANSLATE20250301) newRequest(op *request.Operation, params, data interface{}) *request.Request {
