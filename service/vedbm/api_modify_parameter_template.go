...
//        fmt.Println(resp)
//    }
func (c *VEDBM) ModifyParameterTemplateCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// ModifyParameterTemplateCommon API operation for VEDBM.
//
...
func (c *VEDBM) ModifyParameterTemplateCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *VEDBM) ModifyParameterTemplateCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyParameterTemplateCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *VEDBM) ModifyParameterTemplateRequest(input *ModifyParameterTemplateInput) (req *request.Request, output *ModifyParameterTemplateOutput) {
	op := &request.Operation{
...
// ModifyParameterTemplate API operation for VEDBM.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *VEDBM) ModifyParameterTemplate(input *ModifyParameterTemplateInput) (*ModifyParameterTemplateOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *VEDBM) ModifyParameterTemplateWithContext(ctx volcengine.Context, input *ModifyParameterTemplateInput, opts ...request.Option) (*ModifyParameterTemplateOutput, error) {
	req, out := c.ModifyParameterTemplateRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
type ModifyParameterTemplateInput struct {
	...
	TemplateParameters []*TemplateParameterForModifyParameterTemplateInput `type:"list" json:",omitempty"`
}
...
func (s *ModifyParameterTemplateInput) SetTemplateDescription(v string) *ModifyParameterTemplateInput {
...
func (s *ModifyParameterTemplateInput) SetTemplateParameters(v []*TemplateParameterForModifyParameterTemplateInput) *ModifyParameterTemplateInput {
...
type TemplateParameterForModifyParameterTemplateInput struct {
	_ struct{} `type:"structure" json:",omitempty"`
...
// String returns the string representation
func (s TemplateParameterForModifyParameterTemplateInput) String() string {
	return volcengineutil.Prettify(s)
}

// GoString returns the string representation
func (s TemplateParameterForModifyParameterTemplateInput) GoString() string {
	return s.String()
}

// SetParameterName sets the ParameterName field's value.
func (s *TemplateParameterForModifyParameterTemplateInput) SetParameterName(v string) *TemplateParameterForModifyParameterTemplateInput {
	s.ParameterName = &v
	return s
}

// SetParameterValue sets the ParameterValue field's value.
func (s *TemplateParameterForModifyParameterTemplateInput) SetParameterValue(v string) *TemplateParameterForModifyParameterTemplateInput {
	s.ParameterValue = &v
	return s
}
