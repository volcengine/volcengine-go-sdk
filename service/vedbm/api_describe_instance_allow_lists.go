...
func (c *VEDBM) DescribeInstanceAllowListsCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DescribeInstanceAllowListsCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *VEDBM) DescribeInstanceAllowListsWithContext(ctx volcengine.Context, input *DescribeInstanceAllowListsInput, opts ...request.Option) (*DescribeInstanceAllowListsOutput, error) {
	req, out := c.DescribeInstanceAllowListsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
