...
//        fmt.Println(resp)
//    }
func (c *SECCENTER20240508) DeleteCommandCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// DeleteCommandCommon API operation for SECCENTER20240508.
//
...
func (c *SECCENTER20240508) DeleteCommandCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *SECCENTER20240508) DeleteCommandCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteCommandCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *SECCENTER20240508) DeleteCommandRequest(input *DeleteCommandInput) (req *request.Request, output *DeleteCommandOutput) {
	op := &request.Operation{
...
// DeleteCommand API operation for SECCENTER20240508.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *SECCENTER20240508) DeleteCommand(input *DeleteCommandInput) (*DeleteCommandOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *SECCENTER20240508) DeleteCommandWithContext(ctx volcengine.Context, input *DeleteCommandInput, opts ...request.Option) (*DeleteCommandOutput, error) {
	req, out := c.DeleteCommandRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *DeleteCommandOutput) SetData(v string) *DeleteCommandOutput {
	s.Data = &v
	return s
}
