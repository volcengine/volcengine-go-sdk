...
// SECCENTER20240508 provides the API operation methods for making requests to
// SECCENTER20240508. See this package's package overview docs
// for details on the service.
//
// SECCENTER20240508 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type SECCENTER20240508 struct {
	*client.Client
}
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *SECCENTER20240508 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *SECCENTER20240508 {
	svc := &SECCENTER20240508{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a SECCENTER20240508 operation and runs any
// custom request initialization.
func (c *SECCENTER20240508) newRequest(op *request.Operation, params, data interface{}) *request.Request {
