...
//        fmt.Println(resp)
//    }
func (c *SECCENTER20240508) MultiCloudAccessSyncCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// MultiCloudAccessSyncCommon API operation for SECCENTER20240508.
//
...
func (c *SECCENTER20240508) MultiCloudAccessSyncCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *SECCENTER20240508) MultiCloudAccessSyncCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.MultiCloudAccessSyncCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *SECCENTER20240508) MultiCloudAccessSyncRequest(input *MultiCloudAccessSyncInput) (req *request.Request, output *MultiCloudAccessSyncOutput) {
	op := &request.Operation{
...
// MultiCloudAccessSync API operation for SECCENTER20240508.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *SECCENTER20240508) MultiCloudAccessSync(input *MultiCloudAccessSyncInput) (*MultiCloudAccessSyncOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *SECCENTER20240508) MultiCloudAccessSyncWithContext(ctx volcengine.Context, input *MultiCloudAccessSyncInput, opts ...request.Option) (*MultiCloudAccessSyncOutput, error) {
	req, out := c.MultiCloudAccessSyncRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
