...
const opUpdateInstanceNameCommon = "UpdateInstanceName"

// UpdateInstanceNameCommonRequest generates a "volcengine/request.Request" representing the
// client's request for the UpdateInstanceNameCommon operation. The "output" return
// value will be populated with the UpdateInstanceNameCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned UpdateInstanceNameCommon Request to send the API call to the service.
// the "output" return value is not valid until after UpdateInstanceNameCommon Send returns without error.
//
// See UpdateInstanceNameCommon for more information on using the UpdateInstanceNameCommon
...
func (c *CLOUDIDENTITY) UpdateInstanceNameCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
	op := &request.Operation{
		Name:       opUpdateInstanceNameCommon,
		HTTPMethod: "POST",
		HTTPPath:   "/",
	}
...
// API operation UpdateInstanceNameCommon for usage and error information.
func (c *CLOUDIDENTITY) UpdateInstanceNameCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
	req, out := c.UpdateInstanceNameCommonRequest(input)
	return out, req.Send()
}

// UpdateInstanceNameCommonWithContext is the same as UpdateInstanceNameCommon with the addition of
...
const opUpdateInstanceName = "UpdateInstanceName"

// UpdateInstanceNameRequest generates a "volcengine/request.Request" representing the
// client's request for the UpdateInstanceName operation. The "output" return
// value will be populated with the UpdateInstanceNameCommon request's response once the request completes
// successfully.
//
// Use "Send" method on the returned UpdateInstanceNameCommon Request to send the API call to the service.
// the "output" return value is not valid until after UpdateInstanceNameCommon Send returns without error.
//
// See UpdateInstanceName for more information on using the UpdateInstanceName
// API call, and error handling.
//
...
func (c *CLOUDIDENTITY) UpdateInstanceNameRequest(input *UpdateInstanceNameInput) (req *request.Request, output *UpdateInstanceNameOutput) {
	...
	output = &UpdateInstanceNameOutput{}
	req = c.newRequest(op, input, output)
...
//
// See the VOLCENGINE API reference guide for CLOUDIDENTITY's
// API operation UpdateInstanceName for usage and error information.
func (c *CLOUDIDENTITY) UpdateInstanceName(input *UpdateInstanceNameInput) (*UpdateInstanceNameOutput, error) {
	req, out := c.UpdateInstanceNameRequest(input)
	return out, req.Send()
}

// UpdateInstanceNameWithContext is the same as UpdateInstanceName with the addition of
// the ability to pass a context and additional request options.
//
...
func (s *UpdateInstanceNameInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "UpdateInstanceNameInput"}
	if s.NewName == nil {
