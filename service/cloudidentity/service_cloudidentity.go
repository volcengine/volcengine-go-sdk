...
// CLOUDIDENTITY provides the API operation methods for making requests to
// CLOUDIDENTITY. See this package's package overview docs
// for details on the service.
//
// CLOUDIDENTITY methods are safe to use concurrently. It is not safe to
...
const (
	ServiceName = "cloudidentity" // Name of service.
	EndpointsID = ServiceName     // ID to lookup a service endpoint with.
	ServiceID   = "cloudidentity" // ServiceID is a unique identifer of a specific service.
)
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *CLOUDIDENTITY {
	svc := &CLOUDIDENTITY{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a CLOUDIDENTITY operation and runs any
// custom request initialization.
func (c *CLOUDIDENTITY) newRequest(op *request.Operation, params, data interface{}) *request.Request {
