...
// SPEECHSAASPROD20250521 provides the API operation methods for making requests to
// SPEECH_SAAS_PROD20250521. See this package's package overview docs
// for details on the service.
//
// SPEECHSAASPROD20250521 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type SPEECHSAASPROD20250521 struct {
	*client.Client
}
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *SPEECHSAASPROD20250521 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *SPEECHSAASPROD20250521 {
	svc := &SPEECHSAASPROD20250521{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a SPEECHSAASPROD20250521 operation and runs any
// custom request initialization.
func (c *SPEECHSAASPROD20250521) newRequest(op *request.Operation, params, data interface{}) *request.Request {
