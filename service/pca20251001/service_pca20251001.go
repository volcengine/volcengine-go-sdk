...
// PCA20251001 provides the API operation methods for making requests to
// PCA20251001. See this package's package overview docs
// for details on the service.
//
// PCA20251001 methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *PCA20251001 {
	svc := &PCA20251001{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a PCA20251001 operation and runs any
// custom request initialization.
func (c *PCA20251001) newRequest(op *request.Operation, params, data interface{}) *request.Request {
