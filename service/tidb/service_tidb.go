...
// TIDB provides the API operation methods for making requests to
// TIDB. See this package's package overview docs
// for details on the service.
//
// TIDB methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *TIDB {
	svc := &TIDB{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a TIDB operation and runs any
// custom request initialization.
func (c *TIDB) newRequest(op *request.Operation, params, data interface{}) *request.Request {
