...
// VEENEDGE provides the API operation methods for making requests to
// VEENEDGE. See this package's package overview docs
// for details on the service.
//
// VEENEDGE methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VEENEDGE {
	svc := &VEENEDGE{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VEENEDGE operation and runs any
// custom request initialization.
func (c *VEENEDGE) newRequest(op *request.Operation, params, data interface{}) *request.Request {
