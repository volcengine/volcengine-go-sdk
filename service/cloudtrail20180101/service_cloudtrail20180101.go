...
// CLOUDTRAIL20180101 provides the API operation methods for making requests to
// CLOUD_TRAIL20180101. See this package's package overview docs
// for details on the service.
//
// CLOUDTRAIL20180101 methods are safe to use concurrently. It is not safe to
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *CLOUDTRAIL20180101 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *CLOUDTRAIL20180101 {
	svc := &CLOUDTRAIL20180101{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a CLOUDTRAIL20180101 operation and runs any
// custom request initialization.
func (c *CLOUDTRAIL20180101) newRequest(op *request.Operation, params, data interface{}) *request.Request {
