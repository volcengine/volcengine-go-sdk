...
// WTN provides the API operation methods for making requests to
// WTN. See this package's package overview docs
// for details on the service.
//
// WTN methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *WTN {
	svc := &WTN{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a WTN operation and runs any
// custom request initialization.
func (c *WTN) newRequest(op *request.Operation, params, data interface{}) *request.Request {
