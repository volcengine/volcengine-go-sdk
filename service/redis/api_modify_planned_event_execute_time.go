...
func (c *REDIS) ModifyPlannedEventExecuteTimeCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyPlannedEventExecuteTimeCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *REDIS) ModifyPlannedEventExecuteTimeWithContext(ctx volcengine.Context, input *ModifyPlannedEventExecuteTimeInput, opts ...request.Option) (*ModifyPlannedEventExecuteTimeOutput, error) {
	req, out := c.ModifyPlannedEventExecuteTimeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
