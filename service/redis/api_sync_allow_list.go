...
//        fmt.Println(resp)
//    }
func (c *REDIS) SyncAllowListCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// SyncAllowListCommon API operation for REDIS.
//
...
func (c *REDIS) SyncAllowListCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *REDIS) SyncAllowListCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.SyncAllowListCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *REDIS) SyncAllowListRequest(input *SyncAllowListInput) (req *request.Request, output *SyncAllowListOutput) {
	op := &request.Operation{
...
// SyncAllowList API operation for REDIS.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *REDIS) SyncAllowList(input *SyncAllowListInput) (*SyncAllowListOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *REDIS) SyncAllowListWithContext(ctx volcengine.Context, input *SyncAllowListInput, opts ...request.Option) (*SyncAllowListOutput, error) {
	req, out := c.SyncAllowListRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
type ChangeObjectForSyncAllowListOutput struct {
	...
	AddedIpList []*string `type:"list"`

	BindMode *string `type:"string" json:",omitempty" enum:"EnumOfBindModeForSyncAllowListOutput"`

	HasChanged *bool `type:"boolean" json:",omitempty"`

	HasDeleted *bool `type:"boolean" json:",omitempty"`

	NewIpList []*string `type:"list"`

	OldIpList []*string `type:"list"`

	RemovedIpList []*string `type:"list"`
...
type SecurityGroupBindInfoForSyncAllowListInput struct {
	_ struct{} `type:"structure" json:",omitempty"`

	BindMode *string `type:"string" json:",omitempty" enum:"EnumOfBindModeForSyncAllowListInput"`

	SecurityGroupId *string `type:"string" json:",omitempty"`
}

// String returns the string representation
func (s SecurityGroupBindInfoForSyncAllowListInput) String() string {
	return volcengineutil.Prettify(s)
}

// GoString returns the string representation
func (s SecurityGroupBindInfoForSyncAllowListInput) GoString() string {
	return s.String()
}

// SetBindMode sets the BindMode field's value.
func (s *SecurityGroupBindInfoForSyncAllowListInput) SetBindMode(v string) *SecurityGroupBindInfoForSyncAllowListInput {
	s.BindMode = &v
	return s
}

// SetSecurityGroupId sets the SecurityGroupId field's value.
func (s *SecurityGroupBindInfoForSyncAllowListInput) SetSecurityGroupId(v string) *SecurityGroupBindInfoForSyncAllowListInput {
	s.SecurityGroupId = &v
	return s
}
...
type SyncAllowListInput struct {
	...
	SecurityGroupBindInfos []*SecurityGroupBindInfoForSyncAllowListInput `type:"list"`
}
...
func (s *SyncAllowListInput) SetSecurityGroupBindInfos(v []*SecurityGroupBindInfoForSyncAllowListInput) *SyncAllowListInput {
...
type SyncAllowListOutput struct {
	...
	ChangeObjects []*ChangeObjectForSyncAllowListOutput `type:"list"`
}
...
const (
	// EnumOfBindModeForSyncAllowListInputAssociateEcsIp is a EnumOfBindModeForSyncAllowListInput enum value
	EnumOfBindModeForSyncAllowListInputAssociateEcsIp = "AssociateEcsIp"

	// EnumOfBindModeForSyncAllowListInputIngressDirectionIp is a EnumOfBindModeForSyncAllowListInput enum value
	EnumOfBindModeForSyncAllowListInputIngressDirectionIp = "IngressDirectionIp"
)

const (
	// EnumOfBindModeForSyncAllowListOutputAssociateEcsIp is a EnumOfBindModeForSyncAllowListOutput enum value
	EnumOfBindModeForSyncAllowListOutputAssociateEcsIp = "AssociateEcsIp"

	// EnumOfBindModeForSyncAllowListOutputIngressDirectionIp is a EnumOfBindModeForSyncAllowListOutput enum value
	EnumOfBindModeForSyncAllowListOutputIngressDirectionIp = "IngressDirectionIp"
)
