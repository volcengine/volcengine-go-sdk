...
// CLOUDDETECT provides the API operation methods for making requests to
// CLOUD_DETECT. See this package's package overview docs
// for details on the service.
//
// CLOUDDETECT methods are safe to use concurrently. It is not safe to
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *CLOUDDETECT {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *CLOUDDETECT {
	svc := &CLOUDDETECT{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a CLOUDDETECT operation and runs any
// custom request initialization.
func (c *CLOUDDETECT) newRequest(op *request.Operation, params, data interface{}) *request.Request {
