...
// CDN provides the API operation methods for making requests to
// CDN. See this package's package overview docs
// for details on the service.
//
// CDN methods are safe to use concurrently. It is not safe to
