...
// APMPLUSSERVER provides the API operation methods for making requests to
// APMPLUS_SERVER. See this package's package overview docs
// for details on the service.
//
// APMPLUSSERVER methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *APMPLUSSERVER {
	svc := &APMPLUSSERVER{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a APMPLUSSERVER operation and runs any
// custom request initialization.
func (c *APMPLUSSERVER) newRequest(op *request.Operation, params, data interface{}) *request.Request {
