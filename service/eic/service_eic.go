...
// EIC provides the API operation methods for making requests to
// EIC. See this package's package overview docs
// for details on the service.
//
// EIC methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *EIC {
	svc := &EIC{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a EIC operation and runs any
// custom request initialization.
func (c *EIC) newRequest(op *request.Operation, params, data interface{}) *request.Request {
