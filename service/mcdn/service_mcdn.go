...
// MCDN provides the API operation methods for making requests to
// MCDN. See this package's package overview docs
// for details on the service.
//
// MCDN methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *MCDN {
	svc := &MCDN{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a MCDN operation and runs any
// custom request initialization.
func (c *MCDN) newRequest(op *request.Operation, params, data interface{}) *request.Request {
