...
//        fmt.Println(resp)
//    }
func (c *EMR) UntagResourcesCommonRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
...
// UntagResourcesCommon API operation for EMR.
//
...
func (c *EMR) UntagResourcesCommon(input *map[string]interface{}) (*map[string]interface{}, error) {
...
func (c *EMR) UntagResourcesCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UntagResourcesCommonRequest(input)
	req.SetContext(ctx)
...
//        fmt.Println(resp)
//    }
func (c *EMR) UntagResourcesRequest(input *UntagResourcesInput) (req *request.Request, output *UntagResourcesOutput) {
	op := &request.Operation{
...
// UntagResources API operation for EMR.
//
// Returns volcengineerr.Error for service API and SDK errors. Use runtime type assertions
// with volcengineerr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *EMR) UntagResources(input *UntagResourcesInput) (*UntagResourcesOutput, error) {
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *EMR) UntagResourcesWithContext(ctx volcengine.Context, input *UntagResourcesInput, opts ...request.Option) (*UntagResourcesOutput, error) {
	req, out := c.UntagResourcesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
const (
	// EnumOfResourceTypeForUntagResourcesInputEmr is a EnumOfResourceTypeForUntagResourcesInput enum value
	EnumOfResourceTypeForUntagResourcesInputEmr = "emr"
)
