...
// BYTEHOUSECE20240831 provides the API operation methods for making requests to
// BYTEHOUSE_CE20240831. See this package's package overview docs
// for details on the service.
//
// BYTEHOUSECE20240831 methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *BYTEHOUSECE20240831 {
	svc := &BYTEHOUSECE20240831{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a BYTEHOUSECE20240831 operation and runs any
// custom request initialization.
func (c *BYTEHOUSECE20240831) newRequest(op *request.Operation, params, data interface{}) *request.Request {
