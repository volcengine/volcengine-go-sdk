...
// VIKINGDB provides the API operation methods for making requests to
// VIKINGDB. See this package's package overview docs
// for details on the service.
//
// VIKINGDB methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VIKINGDB {
	svc := &VIKINGDB{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VIKINGDB operation and runs any
// custom request initialization.
func (c *VIKINGDB) newRequest(op *request.Operation, params, data interface{}) *request.Request {
