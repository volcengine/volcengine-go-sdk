...
// GA provides the API operation methods for making requests to
// GA. See this package's package overview docs
// for details on the service.
//
// GA methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *GA {
	svc := &GA{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a GA operation and runs any
// custom request initialization.
func (c *GA) newRequest(op *request.Operation, params, data interface{}) *request.Request {
