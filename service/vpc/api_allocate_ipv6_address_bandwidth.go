...
type AllocateIpv6AddressBandwidthInput struct {
	...
	BillingType *int64 `min:"2" max:"3" type:"integer" required:"true"`
...
func (s *AllocateIpv6AddressBandwidthOutput) SetPreOrderNumber(v string) *AllocateIpv6AddressBandwidthOutput {
	s.PreOrderNumber = &v
	return s
}
