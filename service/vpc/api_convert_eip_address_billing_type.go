...
// ConvertEipAddressBillingTypeCommonRequest generates a "volcengine/request.Request" representing the
...
// ConvertEipAddressBillingTypeRequest generates a "volcengine/request.Request" representing the
...
func (s *ConvertEipAddressBillingTypeInput) SetRenewType(v int64) *ConvertEipAddressBillingTypeInput {
	s.RenewType = &v
	return s
}
...
func (s *ConvertEipAddressBillingTypeOutput) SetPreOrderNumber(v string) *ConvertEipAddressBillingTypeOutput {
	s.PreOrderNumber = &v
	return s
}
