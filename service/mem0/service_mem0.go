...
// MEM0 provides the API operation methods for making requests to
// MEM0. See this package's package overview docs
// for details on the service.
//
// MEM0 methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *MEM0 {
	svc := &MEM0{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a MEM0 operation and runs any
// custom request initialization.
func (c *MEM0) newRequest(op *request.Operation, params, data interface{}) *request.Request {
