...
func (c *CLOUDMONITOR) EnableEventRuleCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.EnableEventRuleCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) EnableEventRuleWithContext(ctx volcengine.Context, input *EnableEventRuleInput, opts ...request.Option) (*EnableEventRuleOutput, error) {
	req, out := c.EnableEventRuleRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
