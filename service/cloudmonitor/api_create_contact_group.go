...
func (c *CLOUDMONITOR) CreateContactGroupCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateContactGroupCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) CreateContactGroupWithContext(ctx volcengine.Context, input *CreateContactGroupInput, opts ...request.Option) (*CreateContactGroupOutput, error) {
	req, out := c.CreateContactGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
