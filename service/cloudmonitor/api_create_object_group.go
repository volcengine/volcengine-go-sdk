...
func (c *CLOUDMONITOR) CreateObjectGroupCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.CreateObjectGroupCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) CreateObjectGroupWithContext(ctx volcengine.Context, input *CreateObjectGroupInput, opts ...request.Option) (*CreateObjectGroupOutput, error) {
	req, out := c.CreateObjectGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
