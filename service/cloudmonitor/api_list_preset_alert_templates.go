...
func (c *CLOUDMONITOR) ListPresetAlertTemplatesCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListPresetAlertTemplatesCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) ListPresetAlertTemplatesWithContext(ctx volcengine.Context, input *ListPresetAlertTemplatesInput, opts ...request.Option) (*ListPresetAlertTemplatesOutput, error) {
	req, out := c.ListPresetAlertTemplatesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
