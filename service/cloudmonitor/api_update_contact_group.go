...
func (c *CLOUDMONITOR) UpdateContactGroupCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateContactGroupCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) UpdateContactGroupWithContext(ctx volcengine.Context, input *UpdateContactGroupInput, opts ...request.Option) (*UpdateContactGroupOutput, error) {
	req, out := c.UpdateContactGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
