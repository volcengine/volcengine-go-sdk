...
func (c *CLOUDMONITOR) DeleteRulesByIdsCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteRulesByIdsCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) DeleteRulesByIdsWithContext(ctx volcengine.Context, input *DeleteRulesByIdsInput, opts ...request.Option) (*DeleteRulesByIdsOutput, error) {
	req, out := c.DeleteRulesByIdsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
