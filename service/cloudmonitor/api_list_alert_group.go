...
func (c *CLOUDMONITOR) ListAlertGroupCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListAlertGroupCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) ListAlertGroupWithContext(ctx volcengine.Context, input *ListAlertGroupInput, opts ...request.Option) (*ListAlertGroupOutput, error) {
	req, out := c.ListAlertGroupRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
