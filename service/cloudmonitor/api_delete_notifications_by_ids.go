...
func (c *CLOUDMONITOR) DeleteNotificationsByIdsCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.DeleteNotificationsByIdsCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) DeleteNotificationsByIdsWithContext(ctx volcengine.Context, input *DeleteNotificationsByIdsInput, opts ...request.Option) (*DeleteNotificationsByIdsOutput, error) {
	req, out := c.DeleteNotificationsByIdsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
