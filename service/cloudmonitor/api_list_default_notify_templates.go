...
func (c *CLOUDMONITOR) ListDefaultNotifyTemplatesCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListDefaultNotifyTemplatesCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) ListDefaultNotifyTemplatesWithContext(ctx volcengine.Context, input *ListDefaultNotifyTemplatesInput, opts ...request.Option) (*ListDefaultNotifyTemplatesOutput, error) {
	req, out := c.ListDefaultNotifyTemplatesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
