...
func (c *CLOUDMONITOR) ListRulesByIdsCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListRulesByIdsCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) ListRulesByIdsWithContext(ctx volcengine.Context, input *ListRulesByIdsInput, opts ...request.Option) (*ListRulesByIdsOutput, error) {
	req, out := c.ListRulesByIdsRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
