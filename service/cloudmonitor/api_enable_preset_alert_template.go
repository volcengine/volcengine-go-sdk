...
func (c *CLOUDMONITOR) EnablePresetAlertTemplateCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.EnablePresetAlertTemplateCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) EnablePresetAlertTemplateWithContext(ctx volcengine.Context, input *EnablePresetAlertTemplateInput, opts ...request.Option) (*EnablePresetAlertTemplateOutput, error) {
	req, out := c.EnablePresetAlertTemplateRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
