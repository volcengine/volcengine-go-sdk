...
func (c *CLOUDMONITOR) UpdateEventRuleCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.UpdateEventRuleCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) UpdateEventRuleWithContext(ctx volcengine.Context, input *UpdateEventRuleInput, opts ...request.Option) (*UpdateEventRuleOutput, error) {
	req, out := c.UpdateEventRuleRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
