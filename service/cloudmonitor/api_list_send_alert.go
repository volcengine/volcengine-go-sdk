...
func (c *CLOUDMONITOR) ListSendAlertCommonWithContext(ctx volcengine.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ListSendAlertCommonRequest(input)
	req.SetContext(ctx)
...
// In the future the SDK may create sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *CLOUDMONITOR) ListSendAlertWithContext(ctx volcengine.Context, input *ListSendAlertInput, opts ...request.Option) (*ListSendAlertOutput, error) {
	req, out := c.ListSendAlertRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
