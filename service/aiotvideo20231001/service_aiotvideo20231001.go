...
// AIOTVIDEO20231001 provides the API operation methods for making requests to
// AIOTVIDEO20231001. See this package's package overview docs
// for details on the service.
//
// AIOTVIDEO20231001 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type AIOTVIDEO20231001 struct {
	*client.Client
}
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *AIOTVIDEO20231001 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *AIOTVIDEO20231001 {
	svc := &AIOTVIDEO20231001{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a AIOTVIDEO20231001 operation and runs any
// custom request initialization.
func (c *AIOTVIDEO20231001) newRequest(op *request.Operation, params, data interface{}) *request.Request {
