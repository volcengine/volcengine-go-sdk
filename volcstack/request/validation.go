...
// OrigErr returns the invalid parameters as a volcstackerr.BatchedErrors value
func (e ErrInvalidParams) OrigErr() error {
	return volcstackerr.NewBatchError(
...
// OrigErr returns nil, Implemented for volcstackerr.Error interface.
