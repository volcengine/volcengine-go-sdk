...
type teeReaderCloser struct {
	...
	// This structure will read from a volcstackbody and write the contents to a logger.
	io.Reader
...
// to a service. Will include the HTTP request volcstackbody if the LogLevel of the
// request matches LogDebugWithHTTPBody.
var LogHTTPRequestHandler = request.NamedHandler{
	Name: "volcstacksdk.client.LogRequest",
	Fn:   logRequest,
}

func logRequest(r *request.Request) {
	logBody := r.Config.LogLevel.Matches(volcstack.LogDebugWithHTTPBody)
	bodySeekable := volcstack.IsReaderSeekable(r.Body)
	...
	if logBody {
		if !bodySeekable {
			r.SetReaderBody(volcstack.ReadSeekCloser(r.HTTPRequest.Body))
		}
		// Reset the request volcstackbody because dumpRequest will re-wrap the
...
var LogHTTPRequestHeaderHandler = request.NamedHandler{
	Name: "volcstacksdk.client.LogRequestHeader",
	Fn:   logRequestHeader,
}
...
// received from a service. Will include the HTTP response volcstackbody if the LogLevel
// of the request matches LogDebugWithHTTPBody.
var LogHTTPResponseHandler = request.NamedHandler{
	Name: "volcstacksdk.client.LogResponse",
	Fn:   logResponse,
}
...
func logResponse(r *request.Request) {
	...
	const handlerName = "volcstacksdk.client.LogResponse.ResponseBody"
...
var LogHTTPResponseHeaderHandler = request.NamedHandler{
	Name: "volcstacksdk.client.LogResponseHeader",
